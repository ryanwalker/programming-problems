...
class Demonstration {
  public static void main( String args[] ) throws InterruptedException {
    DeferredCallbackExecutorEductiveIO.runTestTenCallbacks();
  }
}

class DeferredCallbackExecutorEductiveIO {
  ...
  public static void runTestTenCallbacks() throws InterruptedException {
    ...
    final DeferredCallbackExecutorEductiveIO deferredCallbackExecutor = new DeferredCallbackExecutorEductiveIO();
